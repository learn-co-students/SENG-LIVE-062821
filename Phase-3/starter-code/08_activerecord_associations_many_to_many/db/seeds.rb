...
if Object.const_defined?("Appointment") && Object.const_get("Appointment").table_exists?
  Appointment.destroy_all
  appointments_attributes.each do |attrs| 
    Appointment.find_or_create_by(attrs)
  end
else
  puts "No Appointments created because the Appointment class or table doesn't exist yet"
end 
...
if Object.const_defined?("Walk") && Object.const_get("Walk").table_exists?
  Walk.destroy_all
  walks_attributes.each do |attrs| 
    Walk.find_or_create_by(attrs)
  end
else
  puts "No Walks created because the Walk class or table doesn't exist yet"
end 